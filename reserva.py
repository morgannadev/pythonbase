...
O programa deve salvar essa escolha em outro arquivo contendo as reservas
...
for codigo, dados in quartos.items():
    ...
    # disponivel = dados["disponivel"] and "Disponível" or "Indisponível"
...
print(f"{nome}, você escolheu o quarto {nome_quarto} e vai custar {total}.")